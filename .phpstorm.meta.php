...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/hitesh-vaghela/sandbox/laravel_practice/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/hitesh-vaghela/sandbox/laravel_practice/public/storage','logging.default','logging.deprecations.channel',
...
'session.partitioned','view.paths','view.compiled','concurrency.default','cors.paths',
...
'debugbar.queries.explain','jobs.index',
'jobs.create','jobs.store','jobs.show','jobs.edit','jobs.update',
'jobs.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','components.button','components.form-button','components.form-error',
'components.form-field','components.form-input','components.form-label','components.layout','components.mobile-nav-link',
'components.nav-link','contact','home','jobs.create','jobs.edit',
'jobs.index','jobs.show','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
