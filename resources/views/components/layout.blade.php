                                ...
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full"
                                            src="https://laracasts.com/images/lary-ai-face.png" alt="">
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-10 rounded-full" src="https://laracasts.com/images/lary-ai-face.png"
                                alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Hitesh Vaghela</div>
                            <div class="text-sm font-medium text-gray-400">hitesh@vaghela.com</div>
                        </div>
                        <button type="button"
